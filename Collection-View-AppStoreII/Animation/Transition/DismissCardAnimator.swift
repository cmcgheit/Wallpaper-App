...
final class DismissCardAnimator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    struct Params {
        ...
        let fromCell: PopUpCollectionViewCell
    }
    
    struct DismissConstants {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let screens: (cardDetail: PopUpDetailVC, home: FeedVC) = (
            ctx.viewController(forKey: .from)! as! PopUpDetailVC,
            ctx.viewController(forKey: .to)! as! FeedVC
        )
        ...
        // Fix weird top inset
        let topTemporaryFix = screens.cardDetail.cardView.topAnchor.constraint(equalTo: cardDetailView.topAnchor)
        topTemporaryFix.isActive = Constants.isEnabledWeirdTopInsetsFix
        
        container.layoutIfNeeded()
        
        // Force card filling bottom
        let stretchCardToFillBottom = screens.cardDetail.cardView.bottomAnchor.constraint(equalTo: cardDetailView.bottomAnchor)
