...
public class RoundedRectBlueButton: UIButton {
...
public class RoundedRectPinkButton: UIButton {
    ...
    // color of background rect
    public var roundRectColor: UIColor = wallPink { // all buttons use subclass blue
        didSet {
            self.setNeedsLayout()
        }
    }
...
public class RoundedRectGoldButton: UIButton {
    ...
    // color of background rect
    public var roundRectColor: UIColor = wallGold { // all buttons use subclass blue
        didSet {
            self.setNeedsLayout()
        }
    }
