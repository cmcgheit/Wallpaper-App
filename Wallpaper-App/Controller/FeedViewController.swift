...
class FeedViewController: UIViewController {
    ...
    // MARK: - Configure Drawer View
    private func configureDrawerViewAppearance() {
...
extension FeedViewController: CoachMarksControllerDelegate, CoachMarksControllerDataSource {
    ...
    func coachMarksController(_ coachMarksController: CoachMarksController, coachMarkAt index: Int) -> CoachMark {
        ...
        case 1:
            return coachMarksController.helper.makeCoachMark(for: menuBtn) // change to drawer
        case 2:
...
extension FeedViewController: DrawerViewControllerDelegate {
    ...
    private func animateBackgroundFade(withCurrentTopConstraint currentTopConstraint: CGFloat) {
        ...
        progress = min(FeedViewController.kBackgroundColorOverlayTargetAlpha, progress)
